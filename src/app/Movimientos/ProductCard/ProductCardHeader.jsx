...
const ProductCardHeader = ({ title, onClick, handleCantidad, cantidad }) => {
  return (
    <span style={{ display: "grid", gridTemplateColumns: "60% 30% 10%" }}>
      ...
      <span className='is-size-6 has-text-weight-normal'>
        <label>Cant.: </label> <input value={cantidad || ""} onChange={handleCantidad} type="number" min={0} maxLength={3} style={{ width: "3rem", height: "1.5rem" }} className='input is-small' />
      </span>
