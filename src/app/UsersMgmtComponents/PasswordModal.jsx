...
const PasswordModal = ({ id, closeModal, isAdmin }) => {
	...
	const passUpdate = async () => {
		...
		(result.ok && ToastNotification(response.status, response.message)) ||
			ToastNotification(
				response.status,
				"Algo no ha ido bien:" + response.message
			);
				...
				<div className="modal-content">
					<div className="box">
						...
						<form
							...
							className="form"
						>
							<fieldset style={{ maxWidth: "80vw" }} disabled={loading}>
								{!isAdmin && (
									<InputComponent
										id="password"
										value={oldPassword}
								...
								<InputComponent
									...
									required={true}
								/>
								<div className="buttons" style={{ flexWrap: "wrap-reverse" }}>
